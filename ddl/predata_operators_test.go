...
var _ = Describe("backup/predata_operators tests", func() {
	...
	Describe("PrintCreateOperatorStatements", func() {
		It("prints a basic operator", func() {
			operator := ddl.Operator{Oid: 0, Schema: "public", Name: "##", Procedure: "public.path_inter", LeftArgType: "public.path", RightArgType: "public.path", CommutatorOp: "0", NegatorOp: "0", RestrictFunction: "-", JoinFunction: "-", CanHash: false, CanMerge: false}

			ddl.PrintCreateOperatorStatements(backupfile, toc, []ddl.Operator{operator}, ddl.MetadataMap{})
	...
	RIGHTARG = public.path
		...
		It("prints a full-featured operator", func() {
			operator := ddl.Operator{Oid: 1, Schema: "testschema", Name: "##", Procedure: "public.path_inter", LeftArgType: "public.path", RightArgType: "public.path", CommutatorOp: "testschema.##", NegatorOp: "testschema.###", RestrictFunction: "eqsel(internal,oid,internal,integer)", JoinFunction: "eqjoinsel(internal,oid,internal,smallint)", CanHash: true, CanMerge: true}

			metadataMap := testutils.DefaultMetadataMap("OPERATOR", false, true, true)

			ddl.PrintCreateOperatorStatements(backupfile, toc, []ddl.Operator{operator}, metadataMap)
...
ALTER OPERATOR testschema.## (public.path, public.path) OWNER TO testrole;`)
		...
		It("prints an operator with only a left argument", func() {
			operator := ddl.Operator{Oid: 1, Schema: "public", Name: "##", Procedure: "public.path_inter", LeftArgType: "public.path", RightArgType: "-", CommutatorOp: "0", NegatorOp: "0", RestrictFunction: "-", JoinFunction: "-", CanHash: false, CanMerge: false}
...
ALTER OPERATOR public.## (public.path, NONE) OWNER TO testrole;`)
		...
		It("prints an operator with only a right argument", func() {
			operator := ddl.Operator{Oid: 1, Schema: "public", Name: "##", Procedure: "public.path_inter", LeftArgType: "-", RightArgType: "public.\"PATH\"", CommutatorOp: "0", NegatorOp: "0", RestrictFunction: "-", JoinFunction: "-", CanHash: false, CanMerge: false}
...
ALTER OPERATOR public.## (NONE, public."PATH") OWNER TO testrole;`)
	...
	Describe("PrintCreateOperatorFamilyStatements", func() {
		It("prints a basic operator family", func() {
			operatorFamily := ddl.OperatorFamily{Oid: 0, Schema: "public", Name: "testfam", IndexMethod: "hash"}

			ddl.PrintCreateOperatorFamilyStatements(backupfile, toc, []ddl.OperatorFamily{operatorFamily}, ddl.MetadataMap{})
		...
		It("prints an operator family with an owner and comment", func() {
			operatorFamily := ddl.OperatorFamily{Oid: 1, Schema: "public", Name: "testfam", IndexMethod: "hash"}

			metadataMap := testutils.DefaultMetadataMap("OPERATOR FAMILY", false, true, true)

			ddl.PrintCreateOperatorFamilyStatements(backupfile, toc, []ddl.OperatorFamily{operatorFamily}, metadataMap)
...
ALTER OPERATOR FAMILY public.testfam USING hash OWNER TO testrole;`)
	...
	Describe("PrintCreateOperatorClassStatements", func() {
		It("prints a basic operator class", func() {
			operatorClass := ddl.OperatorClass{Oid: 0, Schema: "public", Name: "testclass", FamilySchema: "public", FamilyName: "testclass", IndexMethod: "hash", Type: "uuid", Default: false, StorageType: "-", Operators: nil, Functions: nil}

			ddl.PrintCreateOperatorClassStatements(backupfile, toc, []ddl.OperatorClass{operatorClass}, ddl.MetadataMap{})
	...
	STORAGE uuid;`)
		...
		It("prints an operator class with default and family", func() {
			operatorClass := ddl.OperatorClass{Oid: 0, Schema: "public", Name: "testclass", FamilySchema: "public", FamilyName: "testfam", IndexMethod: "hash", Type: "uuid", Default: true, StorageType: "-", Operators: nil, Functions: nil}
	...
	STORAGE uuid;`)
		...
		It("prints an operator class with class and family in different schemas", func() {
			operatorClass := ddl.OperatorClass{Oid: 0, Schema: "schema1", Name: "testclass", FamilySchema: `"Schema2"`, FamilyName: "testfam", IndexMethod: "hash", Type: "uuid", Default: true, StorageType: "-", Operators: nil, Functions: nil}
	...
	STORAGE uuid;`)
		...
		It("prints an operator class with an operator", func() {
			operatorClass := ddl.OperatorClass{Oid: 0, Schema: "public", Name: "testclass", FamilySchema: "public", FamilyName: "testclass", IndexMethod: "hash", Type: "uuid", Default: false, StorageType: "-", Operators: nil, Functions: nil}
			operatorClass.Operators = []ddl.OperatorClassOperator{{ClassOid: 0, StrategyNumber: 1, Operator: "=(uuid,uuid)", Recheck: false}}
	...
	OPERATOR 1 =(uuid,uuid);`)
		...
		It("prints an operator class with two operators and recheck", func() {
			operatorClass := ddl.OperatorClass{Oid: 0, Schema: "public", Name: "testclass", FamilySchema: "public", FamilyName: "testclass", IndexMethod: "hash", Type: "uuid", Default: false, StorageType: "-", Operators: nil, Functions: nil}
			operatorClass.Operators = []ddl.OperatorClassOperator{{ClassOid: 0, StrategyNumber: 1, Operator: "=(uuid,uuid)", Recheck: true}, {ClassOid: 0, StrategyNumber: 2, Operator: ">(uuid,uuid)", Recheck: false}}
	...
	OPERATOR 2 >(uuid,uuid);`)
		...
		It("prints an operator class with a function", func() {
			operatorClass := ddl.OperatorClass{Oid: 0, Schema: "public", Name: "testclass", FamilySchema: "public", FamilyName: "testclass", IndexMethod: "hash", Type: "uuid", Default: false, StorageType: "-", Operators: nil, Functions: nil}
			operatorClass.Functions = []ddl.OperatorClassFunction{{ClassOid: 0, SupportNumber: 1, FunctionName: "abs(integer)"}}
