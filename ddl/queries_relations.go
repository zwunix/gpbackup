...
func GetAllUserTables(connection *dbconn.DBConn, leafPartitionData bool) []Relation {
	if len(includeRelations) > 0 {
		return GetUserTablesWithIncludeFiltering(connection, leafPartitionData)
	}
	return GetUserTables(connection, leafPartitionData)
}
 ...
 */
func GetUserTables(connection *dbconn.DBConn, leafPartitionData bool) []Relation {
...
func GetUserTablesWithIncludeFiltering(connection *dbconn.DBConn, leafPartitionData bool) []Relation {
