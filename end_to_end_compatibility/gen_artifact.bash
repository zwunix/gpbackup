...
function setupPlugin() {
    pluginConfigPath="${HOME}/go/src/github.com/greenplum-db/gpbackup/plugins/example_plugin_config.yaml"
    echo "Setting up plugin ${pluginConfigPath} ..."
    pluginExecutablePath="${HOME}/go/src/github.com/greenplum-db/gpbackup/plugins/example_plugin.sh"
